...
def _get_text_encoder_mapping_with_visual():
...
class Qwen21EditWeightDefinition(Qwen21WeightDefinition):
    ...
    (model.visual.*) that lives inside the text_encoder shards and is required to encode
    condition images for editing."""
    ...
    def get_components() -> List[ComponentDefinition]:
        return [
            ...
            ComponentDefinition(
                ...
                mapping_getter=_get_text_encoder_mapping_with_visual,
            ),
        ]
